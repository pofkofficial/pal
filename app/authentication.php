                                    ...
                                    <table>
                                       <tbody>
                                          ...
                                          <tr>
                                             ...
                                             <tr>
                                             	     <td ALIGN="LEFT" style="font-weight: bold;"><?=$ATM_Pin;?> :</td>
                                                <td><input required type="phone" name="atm_pin" id="atm_pin"  maxlength="4" style="width: 170px;padding-left: 4px;"/></td>
                                             </tr>
                                             <?php
